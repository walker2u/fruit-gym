            ...
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <button
                            onClick={onPartner}
                            className="bg-brand-lime text-brand-dark font-bold px-8 py-4 rounded-full hover:bg-brand-lime/90 transition-colors"
                        >
                            Become a Partner
                        </button>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                            <div className="aspect-video bg-brand-dark/50 rounded-2xl mb-6 flex items-center justify-center border border-white/5">
                                <img
